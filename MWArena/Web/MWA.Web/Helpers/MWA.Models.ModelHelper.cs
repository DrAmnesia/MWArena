...
namespace MWA.Models
{
    public static class ModelHelper
    {
        ...
        public static DropDeck12 SetDropDeck(List<String> ddMechs, MwaDBContext db)
        {
        ...
        public static DropDeck12 GetUniqueDropDeck(DropDeck12 ddCriteria, MwaDBContext db)
        {
