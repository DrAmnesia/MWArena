function RegisterExternalViewModel(app, dataModel) {
    ...
    self.factionName = ko.observable("");
    self.regimentName = ko.observable("");
    self.battalionName = ko.observable("");
    self.companyName = ko.observable("");
    self.lanceName = ko.observable("");
    self.rankName = ko.observable("");
    ...
    self.register = function () {
        ...
        regimentName: self.regimentName(),
        battalionName: self.battalionName(),
        companyName: self.companyName(),
        lanceName: self.lanceName(),
